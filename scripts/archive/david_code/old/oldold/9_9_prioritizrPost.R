...
minFWBSolve <- solve(minFWB)



eval_cost_summary(minFWB, minFWBSolve %>% dplyr::select(solution_1))

eval_n_summary(minFWB, minFWBSolve %>% dplyr::select(solution_1))
eval_target_coverage_summary(minFWB, minFWBSolve %>% dplyr::select(solution_1))


minFWBSolve %>% 
  tm_shape() +
  tm_polygons(col = "solution_1")
...
maxFWBSolve <- solve(maxFWB)



eval_cost_summary(maxFWB, maxFWBSolve %>% dplyr::select(solution_1))

eval_n_summary(maxFWB, maxFWBSolve %>% dplyr::select(solution_1))
eval_target_coverage_summary(maxFWB, maxFWBSolve %>% dplyr::select(solution_1))
...
minFBSolve <- solve(minFB)



eval_cost_summary(minFB, minFBSolve %>% dplyr::select(solution_1))

eval_n_summary(minFB, minFBSolve %>% dplyr::select(solution_1))
eval_target_coverage_summary(minFB, minFBSolve %>% dplyr::select(solution_1))
...
maxFBSolve <- solve(maxFB)



eval_cost_summary(maxFB, maxFBSolve %>% dplyr::select(solution_1))

eval_n_summary(maxFB, maxFBSolve %>% dplyr::select(solution_1))
eval_target_coverage_summary(maxFB, maxFBSolve %>% dplyr::select(solution_1))
