...
# Min Fox Water
write_sf(minSetSolve, "./Data/output/minFoxWaterJob.shp")

# Max Fox Water
write_sf(maxSetSolve, "./Data/output/maxFoxWaterJob.shp")

# Min Fox
write_sf(minFoxSolve, "./Data/output/minFoxJob.shp")

# Max Fox
write_sf(maxFoxSolve, "./Data/output/maxFoxJob.shp")

# Min Water
write_sf(minWaterSolve, "./Data/output/minWaterJob.shp")

# Max Water
write_sf(maxWaterSolve, "./Data/output/maxWaterJob.shp")
