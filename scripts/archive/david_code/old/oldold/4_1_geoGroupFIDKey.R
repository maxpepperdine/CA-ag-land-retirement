...
write_sf(irisFields, "./Data/4_geoGroupFIDKey/irisFieldsYear.shp")
...
revenue <- read_csv("Data/1_masterCrosswalk/masterCrosswalk.csv")
...
annual <- read_csv("Data/3_cropRotation/annualKey.csv")
...
irisFields %>% 
  filter(fidIris %in% bad)

write_csv(testCSV, "Data/4_geoGroupFIDKey/geoGroupFIDKey.csv")
