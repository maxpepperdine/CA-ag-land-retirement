...
idealCorridors <- rast("C:/pythonProject - Copy/idealPreRetired_eq3_corridors_truncated_at_200k.tif")
...
write_sf(base, "./Data/10_prioritizrPostRetired/baseR.shp")
...
tableNames <- enframe(c("Max Fox Water Retire", "Min Fox Water Retire", "Max Fox Retire", 
                        "Min Fox Retire", "Max Water Retire", "Min Water Retire", "Ideal Retire"), 
...
foxy <- summaryTable %>% 
  ...
  mutate(
    ...
    `Fox Habitat Fallowed (ha)` = round((absolute_held / 2.471), -1),
...
write_csv(sumTableFinal, "./Data/summaryTableR.csv")


write_csv(cropsFallowed, "./Data/summaryCropTableR.csv")


# Write Shapes ------------------------------------------------------------

# Min Fox Water
write_sf(minSetSolve, "./Data/10_prioritizrPostRetired/minFoxWaterR.shp")

# Max Fox Water
write_sf(maxSetSolve, "./Data/10_prioritizrPostRetired/maxFoxWaterR.shp")

# Min Fox
write_sf(minFoxSolve, "./Data/10_prioritizrPostRetired/minFoxR.shp")

# Max Fox
write_sf(maxFoxSolve, "./Data/10_prioritizrPostRetired/maxFoxR.shp")

# Min Water
write_sf(minWaterSolve, "./Data/10_prioritizrPostRetired/minWaterR.shp")

# Max Water
write_sf(maxWaterSolve, "./Data/10_prioritizrPostRetired/maxWaterR.shp")

# Ideal
write_sf(idealSolve, "./Data/10_prioritizrPostRetired/idealR.shp")
...
write_csv(cropKey, "./Data/10_prioritizrPostRetired/finalCropKeyR.csv")
