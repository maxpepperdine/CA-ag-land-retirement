...
write_sf(base, "./Data/9_prioritizrPost/base.shp")

write_sf(baseRetired, "./Data/9_prioritizrPost/baseRetired.shp")
...
write_sf(idealPre, "./Data/idealPre.shp")
write_sf(idealPreRetired, "./Data/idealPreRetired.shp")
...
# Min Fox Water
write_sf(minSetSolve, "./Data/9_prioritizrPost/minFoxWater.shp")

# Max Fox Water
write_sf(maxSetSolve, "./Data/9_prioritizrPost/maxFoxWater.shp")

# Min Fox
write_sf(minFoxSolve, "./Data/9_prioritizrPost/minFox.shp")

# Max Fox
write_sf(maxFoxSolve, "./Data/9_prioritizrPost/maxFox.shp")

# Min Water
write_sf(minWaterSolve, "./Data/9_prioritizrPost/minWater.shp")

# Max Water
write_sf(maxWaterSolve, "./Data/9_prioritizrPost/maxWater.shp")
