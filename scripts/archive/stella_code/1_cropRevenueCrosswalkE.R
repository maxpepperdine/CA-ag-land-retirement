...
final_rev_e <- kernrev_clean_2021[, c("crop", "year", "harvested_acres", "production", "value", "value_1", "prod_per_acre", "price_per_unit", "price_per_acre")] 

write_csv(final_rev_e, here::here("data/intermediate/final_revenue_e.csv"))
