...
matching <- read_csv(here("data", "matchingSheet.csv")) 
...
# Write to shapefile
write_sf(kern2021_2D, "/Users/stellawing/Desktop/AgAnalysis/data/kernID.shp")
...
# Read the shapefile
kern_shp <- read_sf("/Users/stellawing/Desktop/AgAnalysis/data/kernID.shp")
