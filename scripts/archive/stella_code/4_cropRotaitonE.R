...
masterCrosswalk <- read_csv("/Users/stellawing/Desktop/AgAnalysis/data/masterCrosswalkE.csv") # read in MB masterCrosswalk 
...
# Export 
write_csv(revenueRotationKey, "/Users/stellawing/Desktop/AgAnalysis/data/annualKey_e.csv")
...
# Export
write_sf(cropRotation, "/Users/stellawing/Desktop/AgAnalysis/data/kernYearRotation.shp")
