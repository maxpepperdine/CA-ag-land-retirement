...
outlineRaw <- maxFW <- read_sf("Data/9_prioritizrPost/maxFW.shp") 
...
maxFW <- read_sf("Data/9_prioritizrPost/maxFW.shp")

maxFWB <- read_sf("Data/9_prioritizrPost/maxFWB.shp") %>% 
...
maxF <- read_sf("Data/9_prioritizrPost/maxF.shp")

maxFB <- read_sf("Data/9_prioritizrPost/maxFB.shp") %>% 
  select(id, solution_1) %>% 
  st_drop_geometry()
...
minFW <- read_sf("Data/9_prioritizrPost/minFW.shp")

minFWB <- read_sf("Data/9_prioritizrPost/minFWB.shp") %>% 
  select(id, solution_1) %>% 
  st_drop_geometry()
...
minF <- read_sf("Data/9_prioritizrPost/minF.shp")

minFB <- read_sf("Data/9_prioritizrPost/minFB.shp") %>% 
  select(id, solution_1) %>% 
  st_drop_geometry()
