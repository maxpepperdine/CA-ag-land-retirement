...
sjv <- read_sf(here("data/intermediate/misc/LandIQ_processing/2020/2_cleanPlotsLandIQ_2020/SJVID_2020/SJVID_2020.shp")) %>% 
  clean_names()
...
write_sf(sjv_lastCrop, 
         here("data/intermediate/misc/LandIQ_processing/2020/5_cropRotation_2020/sjvYearRotation/sjvYearRotation_2020.shp"), 
         append = FALSE)
