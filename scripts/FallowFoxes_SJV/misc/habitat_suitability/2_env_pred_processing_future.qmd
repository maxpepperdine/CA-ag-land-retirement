...
The resulting processed raster files will be saved in the `data/intermediate/misc/habitat_suitability/env_predictors/future/bcm_gcm_ensemble/` directory. There will be 24 files produced, one for each combination of climate variable, time period, and emission scenario averaged across all three GCMs (6 vars x 2 time periods x 2 scenarios = 24 files).
...
# define parameters
climate_vars <- c("aet", "cwd", "pet", "ppt", "tmn", "tmx")
...
names(rcp45_2020_2049_stack) <- c("AET RCP45 (2020_2049)", "CWD RCP45 (2020_2049)",
...
names(rcp45_2040_2069_stack) <- c("AET RCP45 (2040_2069)", "CWD RCP45 (2040_2069)",
...
names(rcp85_2020_2049_stack) <- c("AET RCP85 (2020_2049)", "CWD RCP85 (2020_2049)",
...
names(rcp85_2040_2069_stack) <- c("AET RCP85 (2040_2069)", "CWD RCP85 (2040_2069)",
...
aet_diff_plot <- tm_shape(aet_diff_rcp45_2020_2049_vs_baseline, 
  ...
  tm_borders(col = "black", 
             lwd = 0.8) +
  tm_title("AET Δ (rcp45_2020_2049 - baseline)", 
           position = tm_pos_in("right", "top"), 
           size = 1)
...
cwd_diff_plot <- tm_shape(cwd_diff_rcp45_2020_2049_vs_baseline, 
  ...
  tm_borders(col = "black", 
             lwd = 0.8) +
  tm_title("CWD Δ (rcp45_2020_2049 - baseline)", 
           position = tm_pos_in("right", "top"), 
           size = 1)
...
ppt_diff_plot <- tm_shape(ppt_diff_rcp45_2020_2049_vs_baseline, 
  ...
  tm_borders(col = "black", 
             lwd = 0.8) +
  tm_title("PPT Δ (rcp45_2020_2049 - baseline)", 
           position = tm_pos_in("right", "top"), 
           size = 1)
...
tmn_diff_plot <- tm_shape(tmn_diff_rcp45_2020_2049_vs_baseline, 
  ...
  tm_borders(col = "black", 
             lwd = 0.8) +
  tm_title("TMN Δ (rcp45_2020_2049 - baseline)", 
           position = tm_pos_in("right", "top"), 
           size = 1)
...
tmx_diff_plot <- tm_shape(tmx_diff_rcp45_2020_2049_vs_baseline, 
  ...
  tm_borders(col = "black", 
             lwd = 0.8) +
  tm_title("TMX Δ (rcp45_2020_2049 - baseline)", 
           position = tm_pos_in("right", "top"), 
           size = 1)
