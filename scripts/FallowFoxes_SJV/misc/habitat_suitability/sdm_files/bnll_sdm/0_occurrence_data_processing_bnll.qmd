...
Combine the BNLL GBIF occ data with the 7 additional records from [Stewart et al. (2019)](https://doi.org/10.1371/journal.pone.0210766).
...
write_csv(bnll_occur_combined, 
          here("data/raw/occurrence_points/bnll/bnll_occur.csv"))
```
