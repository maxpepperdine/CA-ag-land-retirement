...
This script reads in the prepared BNLL occurrence records (produced in `1_extract_occ_env_data.qmd`) and background points (produced in `2_generate_bg_points.qmd` and `3_extract_bg_env_data.qmd`) to evaluate and generate MaxEnt models using the `dismo` package.
...
occ_data <- read_csv(here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/1_extract_occ_env_data/bnll_occ_env_data.csv"))

# load background data with env data extracted
bg_data <- read_csv(here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/3_extract_bg_env_data/bnll_bg_env_data.csv"))
```
...
occ_data <- occ_data %>%
  dplyr::select(-c(cwd1991_2020_ave, sand_pct_0_10cm, silt_pct_0_10cm, 
...
save(max.eval.bnll, 
     file = here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/max_eval_bnll.rda"))

# load the evaluation results
load(here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/max_eval_bnll.rda"))
```
...
path <- here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/")
...
save(maxent_bnll, 
     file = here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/maxent_prediction_bnll_sdm.rda"))
```
...
load(here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/maxent_prediction_bnll_sdm.rda"))
...
layers_to_drop <- c("cwd1991_2020_ave", "sand_pct_0_10cm", "silt_pct_0_10cm", 
                    "tmn1991_2020_ave", "tmx1991_2020_ave")
...
filename_bnll <- here::here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/maxent_bnll_pred_fillNAs.tif")
...
## define the filename path for the future prediction raster
filename_bnll_rcp45_2040_2069 <- here::here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/future/maxent_bnll_pred_rcp45_2040_2069.tif")
...
writeRaster(bnll_habitat_masked_rcp45_2040_2069, 
            here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/future/maxent_bnll_pred_rcp45_2040_2069_masked_lakes.tif"),
            overwrite = TRUE)
```
...
## define the filename path for the future prediction raster
filename_bnll_rcp85_2020_2049 <- here::here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/future/maxent_bnll_pred_rcp85_2020_2049.tif")
...
writeRaster(bnll_habitat_masked_rcp85_2020_2049, 
            here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/future/maxent_bnll_pred_rcp85_2020_2049_masked_lakes.tif"),
            overwrite = TRUE)
```
...
## define the filename path for the future prediction raster
filename_bnll_rcp85_2040_2069 <- here::here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/future/maxent_bnll_pred_rcp85_2040_2069.tif")
...
thresh_spec_sens <- thresh$spec_sens   # 0.29
```
