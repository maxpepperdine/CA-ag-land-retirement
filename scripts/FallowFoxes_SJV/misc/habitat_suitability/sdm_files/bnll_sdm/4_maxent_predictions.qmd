...
save(max.eval.bnll, 
     file = here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/max_eval_bnll_1-28-26.rda"))

# load the evaluation results
load(here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/max_eval_bnll_1-28-26.rda"))
```
