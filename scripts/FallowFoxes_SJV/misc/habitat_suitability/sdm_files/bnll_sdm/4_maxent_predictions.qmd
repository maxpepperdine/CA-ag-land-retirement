...
env_raster <- rast(here("data/intermediate/misc/habitat_suitability/env_predictors/baseline/keep_NAs/aet1991_2020_ave_CA_270m.tif"))
```
...
env_path <- here("data/intermediate/misc/habitat_suitability/env_predictors/baseline/keep_NAs")
...
names(x_stack) # check the layer names; need to match pred var names in SWD data
...
filename_bnll <- here::here("data/intermediate/misc/habitat_suitability/sdm_files/bnll_sdm/4_maxent_predictions/maxent_bnll_pred.tif")
