...
print(inset_map, vp = grid::viewport(x = 0.75, y = 0.5, width = 0.2, height = 0.25))
```
...
# add inset using viewport
print(inset_map, vp = grid::viewport(x = 0.77, y = 0.4, width = 0.2, height = 0.25))
```
...
# add inset using viewport
print(inset_map, vp = grid::viewport(x = 0.81, y = 0.20, width = 0.2, height = 0.25))
```
