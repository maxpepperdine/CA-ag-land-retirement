...
Calculated in `4_maxent_predictions_sjkf.qmd`, reclassify continuous habitat suitability layers into binary suitable/unsuitable layers using the threshold that maximizes true positive/negative rate (i.e., specificity + sensitivity). This is **0.37** for the sjkf maxent model.

```{r}
# define the reclass matrix
reclass_matrix_future <- matrix(c(0, 0.30, 0,
                                  0.30, 1, 1),
                                ncol = 3, byrow = TRUE)
