...
args <- c("jackknife=TRUE",      # assess variable importance
          ...
          "product=TRUE",       # do not use product features
          ...
          "betamultiplier=1")  # this is the rm coefficient from ENMevaluate()
...
filename_sjkf <- here::here("data/4_maxent_predictions/maxent_sjkf_pred.tif")
...
#ca_lakes <- st_zm(ca_lakes, drop = TRUE, what = "ZM") 
...
writeRaster(sjkf_habitat_masked,
            here("data/4_maxent_predictions/maxent_sjkf_pred_masked_lakes.tif"),
            overwrite = TRUE)
```
...
# assign the correct CRS
stewart_bnll_ext <- st_transform(stewart_bnll_ext, crs(x_fut_stack)) # this was the issue, need to run after running bottom code chunk
...
writeRaster(sjkf_habitat_masked_rcp45_2020_2049, 
            here("data/4_maxent_predictions/maxent_sjkf_pred_rcp45_2020_2049_masked_lakes.tif"),
            overwrite = TRUE)
```
...
## load the environmental data as a raster stack
env_fut_folder <- here("data/future/sjkf/rcp45_2040_2069")
...
## define the filename path for the future prediction raster
filename_sjkf_rcp45_2040_2069 <- here::here("data/future/maxent_sjkf_pred_rcp45_2040_2069.tif")
...
writeRaster(sjkf_habitat_masked_rcp45_2040_2069, 
            here("data/4_maxent_predictions/maxent_sjkf_pred_rcp45_2040_2069_masked_lakes.tif"),
            overwrite = TRUE)
```
...
## load the environmental data as a raster stack
env_fut_folder <- here("data/future/sjkf/rcp85_2020_2049")
...
## define the filename path for the future prediction raster
filename_sjkf_rcp85_2020_2049 <- here::here("data/4_maxent_predictions/maxent_sjkf_pred_rcp85_2020_2049.tif")
...
writeRaster(sjkf_habitat_masked_rcp85_2020_2049, 
            here("data/4_maxent_predictions/maxent_sjkf_pred_rcp85_2020_2049_masked_lakes.tif"),
            overwrite = TRUE)
```
...
## load the environmental data as a raster stack
env_fut_folder <- here("data/future/sjkf/rcp85_2040_2069")
...
## define the filename path for the future prediction raster
filename_sjkf_rcp85_2040_2069 <- here::here("data/4_maxent_predictions/maxent_sjkf_pred_rcp85_2040_2069.tif")
...
writeRaster(sjkf_habitat_masked_rcp85_2040_2069, 
            here("data/4_maxent_predictions/maxent_sjkf_pred_rcp85_2040_2069_masked_lakes.tif"),
            overwrite = TRUE)
```
...
thresh_spec_sens <- thresh$spec_sens   # 0.354 50km buffer - model: fc.QP_rm.1
                                      # 0.225 100 km buffer - model fc.LQP_rm.0.5
```
