...
occ_data <- read_csv(here("data/intermediate/misc/habitat_suitability/sdm_files/gkr_sdm/1_extract_occ_env_data/gkr_occ_env_data.csv"))

# load background data with env data extracted
bg_data <- read_csv(here("data/intermediate/misc/habitat_suitability/sdm_files/gkr_sdm/3_extract_bg_env_data/gkr_bg_env_data.csv"))
```
...
save(max.eval.gkr, 
     file = here("data/intermediate/misc/habitat_suitability/sdm_files/gkr_sdm/4_maxent_predictions/max_eval_gkr.rda"))

# load the evaluation results
load(here("data/intermediate/misc/habitat_suitability/sdm_files/gkr_sdm/4_maxent_predictions/max_eval_gkr.rda"))
```
