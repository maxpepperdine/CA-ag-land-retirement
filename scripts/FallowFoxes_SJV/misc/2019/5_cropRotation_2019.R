...
sjv <- read_sf(here("data/intermediate/misc/2019/2_cleanPlotsLandIQ_2019/SJVID_2019/SJVID_2019.shp")) %>% 
  clean_names()
...
write_sf(sjv_lastCrop, 
         here("data/intermediate/misc/2019/5_cropRotation_2019/sjvYearRotation/sjvYearRotation_2019.shp"), 
         append = FALSE)
