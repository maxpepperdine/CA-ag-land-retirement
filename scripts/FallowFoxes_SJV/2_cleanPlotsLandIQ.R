...
SJV_clean_2022 <- SJV2022Raw %>% 
  ...
  mutate(
    ...
    adate3 = as.Date(adoy3 - 1, origin = "2022-01-01"),
    adate4 = as.Date(adoy4 - 1, origin = "2022-01-01"),
    
    # fixed start and end of water year
    date_active1 = as.Date("2021-10-01"),
    date_inactive4 = as.Date("2022-09-30"),
    
    # other active/inactive dates based on midpoints
    date_active2 = as.Date(date_active2_doy - 1, origin = "2022-01-01"),
    date_active3 = as.Date(date_active3_doy - 1, origin = "2022-01-01"),
    date_active4 = as.Date(date_active4_doy - 1, origin = "2022-01-01"),
    
    date_inactive1 = as.Date(date_inactive1_doy - 1, origin = "2022-01-01"),
    date_inactive2 = as.Date(date_inactive2_doy - 1, origin = "2022-01-01"),
    date_inactive3 = as.Date(date_inactive3_doy - 1, origin = "2022-01-01")
  ) %>%
...
# total acres in LandIQ SJV plots for 2022
total_acres <- SJV2022_2D %>%
  st_drop_geometry() %>%
